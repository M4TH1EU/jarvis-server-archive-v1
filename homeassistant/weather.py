...
def get_replaced_sentence_with_entity(entity_id):
    """
    Return a random sentence from the weather tag with replace keyword (temps, wind, etc.)
    Parameters
    ----------
    entity_id is the entity id of your weather entity in H.A
